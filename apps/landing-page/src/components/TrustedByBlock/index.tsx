  ...
  return (
    <TrustedByBlockSection>
      <Visible height={124}>
        <h3>{t('Trusted by')}</h3>
        <ContentWrapper>
          <ContentImage image={'colore.jpg'} width={6.8675} height={1.63875}></ContentImage>
          <ContentImage image={'beach_born.jpg'} width={6.8675} height={2.74625}></ContentImage>
          <ContentImage image={'plantees.svg'} width={6.86419} height={1.29313}></ContentImage>
          <ContentImage image={'hasonlul.jpg'} width={6.8675} height={1.63875}></ContentImage>
          <ContentImage image={'colore.jpg'} width={6.8675} height={1.63875}></ContentImage>
          <ContentImage image={'mayas.jpg'} width={6.8675} height={3.125}></ContentImage>
          <ContentImage image={'rekorek.jpg'} width={5.49313} height={3.75}></ContentImage>
        </ContentWrapper>
      </Visible>
    </TrustedByBlockSection>
  );
